...
Утверждённый логотип, аватары, favicon-набор и инструкции находятся в
[brand/README.md](brand/README.md). Master SVG зафиксирован контрольной суммой.
Папка хранит исходный комплект бренда. SVG/ICO favicon, PNG 192×192 и Apple
touch icon 180×180 скопированы из утверждённых экспортов в `src/` и публикуются
сборкой по стабильным URL в корне сайта. Остальной архив `brand/` не входит в `dist/`.
